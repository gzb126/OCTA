...
parser.add_argument('--input', type=str, default=r'F:\2_PycharmWorks\OCTAReadProject\imgfiles\第一次访视\octa\1\DataFiles\E106')
parser.add_argument('--output', type=str, default=r'F:\2_PycharmWorks\OCTAReadProject\imgfiles\第一次访视\octa\1\out')
